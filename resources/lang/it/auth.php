...
return [
    ...
    */
    ...
    'failed' => 'Credenziali non riconosciute.',
    'throttle' => 'Troppi tentativi di accesso. Ti preghiamo di riprovare tra :seconds secondi.',
    'not_authorized' => 'Non sei autorizzato a eseguire questa azione.',
    'signup_disabled' => 'La registrazione è al momento disabilitata',
    ...
    '2fa_wrong_validation' => 'Autenticazione a due fattori fallita.',
    '2fa_one_time_password' => 'Codice di autenticazione a due fattori',
    '2fa_recuperation_code' => 'Inserisci un codice di recupero',
    ...
    'login_again' => 'Per favore, effettua di nuovo il login',
    'email' => 'Email',
    'password' => 'Password',
    ...
    'use_recovery' => 'Oppure utilizza un <a href=":url">codice di recupero</a>',
    'signup_no_account' => 'Non hai ancora un account?',
    'signup' => 'Iscriviti',
    'create_account' => 'Crea il primo account, <a href=":url">registrati</a>',
    'change_language_title' => 'Cambia lingua:',
    'change_language' => 'Imposta lingua su :lang',

    'password_reset_title' => 'Reimposta password',
    'password_reset_email' => 'Indirizzo Email',
    'password_reset_send_link' => 'Invia link per ripristino password',
    'password_reset_password' => 'Password',
    'password_reset_password_confirm' => 'Conferma password',
    'password_reset_action' => 'Reimposta Password',
    'password_reset_email_content' => 'Clicca qui per ripristinare la tua password:',

    'register_title_welcome' => 'Benvenuto nella tua nuova installazione di Monica',
    'register_create_account' => 'È necessario creare un account per poter utilizzare Monica',
    'register_title_create' => 'Crea il tuo account Monica',
    'register_login' => '<a href=":url">Accedi</a> se hai già un account.',
    'register_email' => 'Inserisci un indirizzo Email valido',
    'register_email_example' => 'giovanni@bianchi.it',
    ...
    'register_password_example' => 'Inserisci una password sicura',
    'register_password_confirmation' => 'Conferma password',
    'register_action' => 'Registrati',
    'register_policy' => 'La registrazione implica che tu abbia letto e accettato la nostra <a href=":url" hreflang=":hreflang">Privacy Policy</a> e i <a href=":urlterm" hreflang=":hreflang">Termini di Utilizzo</a>.',
    ...
    'email_changed' => 'Il tuo indirizzo email è stato cambiato. Controlla la tua casella per verificarlo.',
];
